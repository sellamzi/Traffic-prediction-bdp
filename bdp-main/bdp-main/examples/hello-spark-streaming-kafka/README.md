...
Example Spark *streaming* program that reads strings from an input topic, capitalizes them, and writes them to an output topic.
...
```
cd hello-spark-streaming-kafka
